...
#ifndef TICTAC_IP_D_DFF_HPP
#define TICTAC_IP_D_DFF_HPP

#include "IP_D_BaseElement.hpp"
#include "IP_NetworkNode.hpp"
#include "sim_utils.hpp"

class IP_D_DFF : public IP_D_BaseElement
{
 public:
  IP_D_DFF(std::string name_space, std::string model_name)
  ...
  IP_D_DFF& data(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    data_ = network_node;
    return *this;
  };
  ...
  IP_D_DFF& clk(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    clk_ = network_node;
    return *this;
  };
  ...
  IP_D_DFF& set(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    set_ = network_node;
    return *this;
  };
  ...
  IP_D_DFF& reset(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    reset_ = network_node;
    return *this;
  };
  ...
  IP_D_DFF& out(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    out_ = network_node;
    return *this;
  };
  ...
  IP_D_DFF& nout(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    nout_ = network_node;
    return *this;
  };
  ...
  {
    SIM_PRINT_L5(verb(), "We are in the d_dff!!!");
