...
#ifndef TICTAC_IP_D_INVERTER_HPP
#define TICTAC_IP_D_INVERTER_HPP

#include "IP_D_BaseElement.hpp"
#include "IP_NetworkNode.hpp"
#include "sim_utils.hpp"

class IP_D_Inverter : public IP_D_BaseElement
{
 public:
  IP_D_Inverter(std::string name_space, std::string model_name)
      : IP_D_BaseElement(name_space, model_name)
  {
    ;
  }
  /// empty Dtor
  virtual ~IP_D_Inverter() { ; }

  virtual void Accept(IP_NetlistVisitBase& visitor) { visitor.Visit(*this); }

  TICTAC_SPTR<IP_NetworkNode> in() { return in_; };
  IP_D_Inverter& in(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    in_ = network_node;
    return *this;
  };
  ...
  IP_D_Inverter& out(TICTAC_SPTR<IP_NetworkNode> network_node)
  {
    out_ = network_node;
    return *this;
  };
...
#endif // TICTAC_IP_D_INVERTER_HPP